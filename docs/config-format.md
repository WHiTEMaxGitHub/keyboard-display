...
| `platformLabels` | object | Optional per-platform display labels. Supported keys are `macos` and `windows`; the visual editor keeps these fields behind a closed advanced control by default. |
